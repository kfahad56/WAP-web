                        ...
                        <div className="row">
                            <div className="col-md-12 privacy">
                                ...
                                <ul style={{ listStyle: "none" }}>
                                    <li><b>1.</b>  These terms and conditions create a contract between you and WAP Technology Service India Private Limited (“WAP Technology/the Company”). By agreeing to these terms and conditions or by accessing, downloading, installing or otherwise using the Website, you accept and agree to the terms and conditions herein. If you do not agree to any of these terms, then please do not use the Website or avail of the Services of WAP Technology.</li><br />
                                    <li><b>2.</b>  By accepting the terms of use of this Agreement, the Client agrees to be bound by its terms as if this Agreement were signed physically. If you are a Client, upon accepting the terms of use of this Agreement, you would receive a separate email from WAP Technology with the Commercial Terms which would form part and parcel of these terms and conditions/Agreement. </li><br />
                                ...
                                <ul style={{ listStyle: "none" }}>
                                    ...
                                    <li><b>6.</b>	CONSIGNMENT NOTE: “Consignment Note” shall refer to the information of the Goods to be dispatched to by the Client to the Partner or by the Partner, as the case maybe, which is to be provided by the Client to WAP Technology. Any reference to the term “Consignment Note” in this Agreement shall include delivery note, proof of delivery, invoice, advance shipping notice and all such other documents which would be applicable as per standard industry practice.</li><br />
                                    <li><b>7.</b>	COMMERCIAL TERMS: “Commercial Terms” shall refer to the agreement entered between WAP and the Client governing the commercial and payment terms which shall form part and parcel of this Agreement and which shall be made available to the Client either by email or through the WAP online portal. </li><br />
                                    <li><b>8.</b>	END CUSTOMER or CLIENT: “End Customer” or “Client” shall refer to the customer who shall be requiring warehousing and logistic services provided by WAP Technology through the Website, for Services and Storage Services or transporting of Goods under this Agreement as per the Commercial Terms.</li><br />
                                    ...
                                    <li><b>12.</b>	SERVICES: "Services" shall refer to any service offered or rendered by WAP Technology or its affiliates and includes warehousing and logistics services along with other technological, operational assistance and inventory management support services that are required by the Client.</li><br />
                                    ...
                                    <li><b>14.</b>	PARTNER: “Partner” shall refer to a warehouse operator or any individual person or a legal entity who has represented to WAP Technology that it has the necessary experience and infrastructure to undertake any or all of the following required activities - receiving and dispatching goods, loading, unloading and storage of goods and management of Warehouse. The Partner has agreed to offer such Warehouses on behalf of WAP Technology.</li><br />
                                    <li><b>15.</b>	WEBSITE: "Website or Site" shall refer to www.WAP.in or such other website WAP Technology notifies for the purposes of this Agreement. </li><br />
                                    <li><b>16.</b>	WAREHOUSE: “Warehouse” shall refer to the storage facility that the Partner is the true and legal owner, which is made available on the WAP platform for usage by WAP clients for warehousing or storage services. </li><br />
                                    <li><b>17.</b>	“We”, “Our”, and “Us” shall refer to WAP Technology.</li><br />
                                    <li><b>18.</b>	YOU/YOUR/USER: "You/Your/User" shall refer to the Client or any person who accesses, downloads, installs, utilizes, operates or views the Website or Services offered by WAP Technology.</li><br />
                                </ul>
                                <h4>III. PRIVACY POLICY</h4>
                                <p><b>A. Eligibility</b></p>
                                <p>You may use the Website only if you can form a contract with WAP Technology, and only in compliance with this Agreement and all Applicable Laws, rules and regulations. You must be at least 18 years old to use the Website and Services. By agreeing to this Agreement, you represent and warrant that you are 18 years of age or older. Any acceptance or use or access to the Website or Services by anyone under 18 is strictly prohibited and in violation of this Agreement. Any use of WAP’s Website or Services by ‘bots’ or other automated tools or methods is not permitted under this Agreement.  The Website and Services not available to any users previously removed from Website Site by WAP Technology.</p>
                                <p><b>B. WAP Technology Website</b></p>
                                <p>Subject to the terms and conditions of this Agreement, you are hereby granted a non-exclusive, limited, non-transferable, revocable license to use the Website for your use only and as permitted by the features of the Website. WAP Technology reserves all rights not expressly granted herein in the Website and the WAP Technology Content (as defined below). WAP Technology may terminate this license at any time without assigning any reason.</p>
                                <p><b>C. WAP Technology Accounts</b></p>
                                <ul style={{ listStyle: "none" }}>
                                    <li><b>1.</b>	Your WAP Technology account gives you access to the Services and functionality that we may establish and maintain from time to time and in our sole discretion. If you accept the terms of this Agreement on behalf of a company, organization, or other entity, then (a) "You" includes you and that entity, and (b) you represent and warrant on each date that you use the Website that you are an authorized representative of the entity with the authority to bind the entity to this Agreement, and that you agree to this Agreement on the entity's behalf. </li><br />
                                    <li><b>2.</b>	You may never use another User's account without permission. When creating your account, you must provide accurate and complete information. You are solely responsible for the activity that occurs on your account, and you are responsible for and must keep your account (including its password) secure. We encourage you to use "strong" passwords (passwords that use a combination of upper- and lower-case letters, numbers and symbols) with your account. You must notify WAP Technology immediately of any breach of security or unauthorized use of your account. WAP Technology will not be liable for any losses caused by any unauthorized use of your account.</li><br />
                                    <li><b>3.</b>	You may control your User profile and account settings by emailing us at contact@WAP.in . By providing WAP Technology your email address, you consent to our using the email address to send you Website and Services related notices, including any notices required by law, in lieu of communication by postal mail. We may also use your email address to send you other messages, such as changes to features of the Website and Services and special offers. If you do not want to receive such email messages, you may opt out or change your preferences by emailing us at contact@WAP.in. </li>
                                </ul>
                                <h4>V.	WAP TECHNOLOGY’S OBLIGATIONS</h4>
                                <ul style={{ listStyle: "none" }}>
                                    <li><b>1.</b>	WAP Technology is engaged in providing warehousing and logistics services via its Website wherein the Partner and Client have a platform to offer or access warehousing and logistics services along with other technological, operational assistance and inventory management support services. </li><br />
                                    <li><b>2.</b>	WAP Technology shall endeavor to facilitate the transaction between the Partner and the Client to the best of its ability, as per the agreed Commercial Terms. </li><br />
                                    <li><b>3.</b>	WAP Technology further provides Services such as inventory management and warehousing in various geographies from across States to have their Goods stored, loaded, transported and delivered. </li><br />
                                    <li><b>4.</b>	WAP Technology endeavors to undertake a complete and thorough check of the Storage Services facilities , approve and validate the same.</li><br />
                                    <li><b>5.</b>	WAP Technology shall further conduct regular inspections of the premises of the Partner where it provides Storage Services under this Agreement. </li><br />
                                    <li><b>6.</b>	WAP Technology shall, to the best of its ability and efforts, ensure quick and smooth transportation and deliveries of Goods, as agreed in the Commercial Terms. </li><br />
                                    <li><b>7.</b>	WAP Technology shall make available, either by e-mail or through its WAP online portal, the Commercial Terms to the Partner separately which agreement shall govern the commercial terms between the parties. </li>
                                </ul>
                                <h4>VI.	TERMS OF USE FOR CLIENTS</h4>
                                <p><b>1.</b>	The Client shall make and send a Consignment Note containing following information for the Goods to be dispatched to Partner using the electronic platform provided by WAP Technology or any other means agreed;</p>
                                <ul style={{ listStyle: "none" }}>
                                ...
                                <p><b>2.</b> The Client shall prepare and deliver the Consignment Note to WAP Technology within such timeframes and by using such practices and methods as may be specified by WAP Technology from time to time in consultation with the Client.</p>
                                <p><b>3.</b> The Client shall dispatch to Partner such stock of Goods that requires warehousing or secondary distribution or as may be indicated by Client in writing or through electronic means as agreed With WAP Technology from time to time in the Commercial Terms. </p>
                                <p><b>4.</b> The Client shall from time to time require Partner to dispatch specified quantities of Goods or that are stored in the Warehouse to specified destinations or persons as instructed in writing or through electronic means as agreed With WAP Technology  from time to time by way of delivery orders.</p>
                                ...
                                <p><b>9.</b> The Client shall not hold WAP Technology responsible for any damage or delay caused by the Partner since the Client acknowledges that WAP Technology has to the best of its ability ensured that the Services under this Agreement are provided smoothly and efficiently without any hinderance. </p>
                                <p><b>10.</b>	The Client shall promptly pay all invoices raised by Partner or WAP Technology in accordance with Commercial Agreement. </p>
                                ...
                                <p><b>16.</b>	The Client shall co-operate and assist WAP Technology in order to enable WAP Technology to provide the Services.</p>
                                ...
                                <ul style={{ listStyle: "none" }}>
                                    ...
                                    <li><b>c.</b>	ANY LOSS OR DAMAGE OR INCREASE IN LOSS OR DAMAGE RESULTS FROM A BREACH BY YOU OF THESE TERMS AND CONDITIONS.THE MAXIMUM LIABILITY SHALL BE LIMITED TO THE EXTENT OF THE VALUE OF THE COMMERCIAL TERMS AND NOT THE COST OF THE GOODS, OR SERVICES AVAILED BY THE CUSTOMER, WAP TECHNOLOGY SHALL NOT BE LIABLE FOR ANY INDIRECT, CONSEQUENTIAL OR OTHER DAMAGES CAUSED TO THE USER.</li><br />
                                    <li><b>d.</b>	WAP TECHNOLOGY WILL NOT BE RESPONSIBLE OR HELD LIABLE FOR ANY DAMAGE CAUSED TO THE GOODS OR FOR ANY NON-PERFORMANCE ON PART OF THE PARTNER OR THE CLIENT, AS THE CASE MAYBE. ANY CLAIM ARISING OUT OF SUCH DAMAGE OR NON-PERFORMANCE WILL BE STRICTLY BETWEEN THE PARTNER AND THE CLIENT.</li><br />
                                </ul>
                                ...
                                <p><b>1.</b>	WAP Technology shall not be held liable for any loss, damage or injury pertaining to use of the Website and Services offered under this Agreement and it shall be the sole risk of the User. The Website and Services provided by WAP Technology are provided on an "as is", "where is" and "as available" basis without any warranties or conditions (express or implied, including the implied warranties of merchantability, accuracy, fitness for a particular purpose, title and non-infringement, arising by statute or otherwise in law or from a course of dealing or usage or trade).</p>
                                <p><b>2.</b>	The User understands and agrees that WAP Technology is a technology platform through which warehousing and logistics services are facilitated and shall not hold WAP Technology responsible for any act or actions of any of the other third parties or other stakeholders involved in the transaction.</p>
                                <p><b>3.</b>	WAP Technology shall not be held responsible or liable for any theft, accident or burglary or any other incident of the Goods.</p>
                                <p><b>4.</b>	WAP Technology shall not be held responsible for any disputes between the Partner and the Client and You shall absolve WAP Technology of all liabilities and disputes that may arise amongst yourselves.</p>
                                <p><b>5.</b>	WAP Technology shall not be held responsible or liable for any of the service deficiency or any other deficiency or delay on part of the Partner availed through the Website.</p>
                                <p><b>6.</b>	WAP Technology shall not be held liable for any defect, damage or vulnerability in the Website, or for any injury or damage or loss to the User due to such defect, damage or vulnerability. </p>
                                <p><b>7.</b>	WAP Technology does not warrant that your access to the Website and/or related Services will be uninterrupted or error-free, that defects will be corrected or that this website or the server that makes it available, is free of viruses or other harmful components.</p>
                                <p><b>8.</b>	Access to and use of the Website and the information contained therein is at your own risk and WAP Technology does not undertake any accountability for any irregularities, viruses or damage to any mobile phone or electronic device that results from accessing, availing or downloading of any information from the application or any other website of which link is provided herewith. </p>
                                <p><b>9.</b>	WAP Technology shall not be held responsible for the confidentiality, secrecy and security of the personal or account information being sent through the Website for effecting the transaction.</p>
                                <p><b>10.</b>	WAP Technology does not warrant or make any representations regarding the use or the results of the use of any service availed in terms of its compatibility, correctness, accuracy, and reliability or otherwise. The User solely assume total responsibility and risk for your use of this Website and Website -related services.</p>
                                <p><b>11.</b>	WAP Technology shall not be held liable for any loss suffered by the user due to disclosure of the personal information to a third-party by WAP Technology, for reasons inclusive but not limited to participation in any telecommunication or electronic clearing network, in compliance with a legal directive, for statistical analysis or for credit rating.</p>
                                <p><b>12.</b>	WAP Technology does not warrant the confidentiality or security of the messages whether personal or otherwise transmitted through the Website or the WAP online portal. </p>
                                <p><b>13.</b>	WAP Technology makes no warranty or representation of any kind in relation to the system and the network or their function or performance or for any loss or damage whenever and howsoever suffered or incurred by the User or by any person resulting from or in connection with the Application.</p>
                                <p><b>14.</b>	WAP Technology shall be absolved of any liability in case there is any unauthorized use of the User's access to Website, or electronic device or for any fraudulent, duplicate or erroneous transaction initiated or requested or instructed by use of the User's Website.</p>
                                <p><b>15.</b>	The User agrees that, WAP Technology and its directors, officers, employees, agents, sponsors, consultants, business partners or other representatives shall not be responsible or liable for any direct, indirect, incidental, consequential, special, exemplary, punitive or any other damages (including without limitation loss of profits, loss or corruption of data, loss of goodwill, work stoppage, computer failure or malfunction or interruption of business) under any contract, negligence, strict liability or other theory arising out of or relating in any way with the use of the Website, Website Services or in reliance of the information available on the Website, Website-related Services or any products or Services offered or sold or displayed on this Website. If the foregoing limitation is held to be unenforceable, the maximum liability of WAP Technology and its service providers to the User shall not under any event exceed the amount of INR 5000 only.</p>
                                <p><b>16.</b>	The User fully and unconditionally agrees and understands that a possibility exists that the Website could include inaccuracies or errors and further that WAP Technology shall not be held liable for any such inaccuracies or errors. Additionally, a possibility exists that unauthorized additions, deletions or alterations could be made by third-parties to the WAP Technology. Although WAP Technology attempts to ensure the integrity, correctness and authenticity of the Website, WAP Technology makes no guarantees whatsoever as to the completeness, correctness or accuracy. In the event that such an inaccuracy arises, the User shall inform WAP Technology so that the same may be corrected.</p>
                                <p><b>17.</b>	It is the User's responsibility to maintain the confidentiality of their user account information, user account password, bank account information, including their password / PIN, safeguarding their money and any other activity including transactions that are posted to or made from your account. WAP Technology shall not be liable for any leak of information on the part of the User and the consequences of the same.</p>
                                <p><b>18.</b>	Neither WAP Technology nor the User will be liable for any delay or failure caused by conditions or events beyond the reasonable control of the respective party, including but not limited to any delay or failure due to any act of God, fire, act of terrorists, act of civil or military authorities, civil disturbance, war, strike or other labor dispute, interruption in telecommunications or internet services or network provider services, failure of equipment and/or software, other catastrophe or any other occurrence which is beyond reasonable control of the respective party and the validity and enforceability of any remaining provisions shall not be affected by any such condition.</p>
                                ...
                                <p>The User agrees to indemnify, defend and hold harmless WAP Technology from and against any and all losses, liabilities, claims, damages, costs and expenses (including legal fees and disbursements in connection therewith and interest chargeable thereon) asserted against or incurred by WAP Technology that arise out of, result from, or may be payable by virtue of, any breach or non-performance of any representation, warranty, covenant or agreement made or obligation to be performed by the User pursuant to this Agreement.</p>
                                <p><b>4. Limited user</b></p>
                                <p>The User agrees and undertakes not to sell, trade or resell or exploit for any commercial purposes, any portion of the products or services, without WAP Technology’s prior written consent. </p>
                                ...
                                <ul style={{ listStyle: "none" }}>
                                    ...
                                    <li><b>b.</b>	The Client agrees not to terminate this Agreement unilaterally and without affording any justifiable reasons in writing to WAP Technology. Any such notice of termination shall be made in writing and WAP Technology has the sole discretion to either accept such termination or not depending on the movement of the Goods and various other factors.</li><br />
                                    <li><b>c.</b>	Without prejudice to the other rights of WAP Technology under this Agreement or otherwise, this Agreement may be terminated forthwith upon or at any time after the happening of any of the following events:</li><br />
                                    ...
                                    <li><b>e.</b>	Provided further, that on termination on the grounds contained in this clause hereinabove, WAP Technology reserves its rights to adjust any financial loss suffered by it for reason of breach of the terms of this Agreement against the amount payable by WAP Technology to Client. Notwithstanding anything mentioned in this agreement, neither Party shall in any event be liable one to the other for their respective consequential damage arising out of loss, damage and delay, including but not limited to indirect losses and loss of revenue, profit or anticipated profits whether or not due in whole or in part to the negligence or breach of duty, statutory or otherwise, of the other party.</li><br />
                                    <li><b>f.</b>	Provided further that no transaction which has taken place prior to the termination shall stand terminated unless otherwise agreed upon by WAP Technology.</li><br />
                                    <li><b>g.</b>	WAP Technology reserves the right, in its sole discretion, to terminate the access to the Website and the related services or any portion thereof at any time, without notice. </li><br />
                                </ul>
                                <p><b>6. Relationship</b></p>
                                <p>None of the provisions of this Agreement, terms and conditions, notices or the right to use the Website  by the User contained herein or any other section or pages of the Website  and/or the linked sites, shall be deemed to constitute a partnership between the Client and WAP Technology and no party shall have any authority to bind or shall be deemed to be the agent of the other in any Way. </p>
                                <p><b>7. Rights of Intellectual Property</b></p>
                                <p><b>a. Copyright: </b>All the contents like list of warehouses, customer information, trade secrets, technical know-how, information related to the transactions etc. is the property of WAP Technology and is completely protected by Indian law of Copyright. The content is also the exclusive property of WAP Technology.</p>
